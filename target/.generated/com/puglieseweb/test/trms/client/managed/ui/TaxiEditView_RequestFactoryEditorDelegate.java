...
public class TaxiEditView_RequestFactoryEditorDelegate extends com.google.gwt.requestfactory.client.impl.RequestFactoryEditorDelegate {
  private com.puglieseweb.test.trms.client.managed.ui.TaxiEditView editor;
  protected com.puglieseweb.test.trms.client.managed.ui.TaxiEditView getEditor() {return editor;}
  protected void setEditor(com.google.gwt.editor.client.Editor editor) {this.editor=(com.puglieseweb.test.trms.client.managed.ui.TaxiEditView)editor;}
  ...
  public static void traverseEditor(com.puglieseweb.test.trms.client.managed.ui.TaxiEditView editor, String prefix, java.util.List<String> paths) {
  }
}
