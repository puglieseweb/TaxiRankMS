...
public class SimplePager_Resources_default_InlineClientBundleGenerator implements com.google.gwt.user.cellview.client.SimplePager.Resources {
  ...
  private void _init0() {
    ...
    public String getText() {
      return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GLLMHHUDMF{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";}.GLLMHHUDKF{padding:" + ("4px")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GLLMHHUDLF{cursor:" + ("default")  + ";}")) : ((".GLLMHHUDMF{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";}.GLLMHHUDKF{padding:" + ("4px")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GLLMHHUDLF{cursor:" + ("default")  + ";}"));
    }
