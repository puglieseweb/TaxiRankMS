...
public class CellList_Resources_default_InlineClientBundleGenerator implements com.google.gwt.user.cellview.client.CellList.Resources {
  ...
  private void _init0() {
    ...
    public String getText() {
      return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GLLMHHUDJ,.GLLMHHUDL{cursor:" + ("pointer")  + ";zoom:" + ("1")  + ";}.GLLMHHUDK{background:" + ("#ffc")  + ";}.GLLMHHUDM{height:" + ((CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getURL() + "\") -" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getLeft() + "px -" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getTop() + "px  repeat-x")  + ";background-color:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("visible")  + ";}")) : ((".GLLMHHUDJ,.GLLMHHUDL{cursor:" + ("pointer")  + ";zoom:" + ("1")  + ";}.GLLMHHUDK{background:" + ("#ffc")  + ";}.GLLMHHUDM{height:" + ((CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getURL() + "\") -" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getLeft() + "px -" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getTop() + "px  repeat-x")  + ";background-color:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("visible")  + ";}"));
    }
  ...
  static {
    new CellList_Resources_default_InlineClientBundleGenerator()._init0();
  }
