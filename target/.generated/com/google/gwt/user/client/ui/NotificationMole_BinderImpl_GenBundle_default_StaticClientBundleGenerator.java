...
public class NotificationMole_BinderImpl_GenBundle_default_StaticClientBundleGenerator implements com.google.gwt.user.client.ui.NotificationMole_BinderImpl_GenBundle {
  ...
  private void _init0() {
    ...
    public String getText() {
      return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GLLMHHUDAI{position:" + ("absolute")  + ";height:" + ("0")  + ";text-align:" + ("center")  + ";width:" + ("100%")  + ";}.GLLMHHUDPH{margin-right:" + ("auto")  + ";margin-left:" + ("auto")  + ";border-right:" + ("1px"+ " " +"solid"+ " " +"#96a2b5")  + ";border-left:" + ("1px"+ " " +"solid"+ " " +"#96a2b5")  + ";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#96a2b5")  + ";background-color:" + ("#e5edf9")  + ";padding:") + (("5px")  + ";overflow:" + ("hidden")  + ";display:" + ("inline-block")  + ";}.GLLMHHUDBI{font-family:" + ("Helvetica")  + ";font-size:" + ("1em")  + ";}")) : ((".GLLMHHUDAI{position:" + ("absolute")  + ";height:" + ("0")  + ";text-align:" + ("center")  + ";width:" + ("100%")  + ";}.GLLMHHUDPH{margin-left:" + ("auto")  + ";margin-right:" + ("auto")  + ";border-left:" + ("1px"+ " " +"solid"+ " " +"#96a2b5")  + ";border-right:" + ("1px"+ " " +"solid"+ " " +"#96a2b5")  + ";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#96a2b5")  + ";background-color:" + ("#e5edf9")  + ";padding:") + (("5px")  + ";overflow:" + ("hidden")  + ";display:" + ("inline-block")  + ";}.GLLMHHUDBI{font-family:" + ("Helvetica")  + ";font-size:" + ("1em")  + ";}"));
    }
