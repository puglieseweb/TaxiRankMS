 ...
 * {@link com.puglieseweb.test.trms.client.scaffold.place.Place Place}s your app can navigate to. In
 ...
 * {@link com.puglieseweb.test.trms.client.scaffold.place.ProxyListPlace ProxyListPlace}s (which show
 * all entities of a particular type) and
 * {@link com.puglieseweb.test.trms.client.scaffold.place.ProxyPlace ProxyPlace}s (which give access to
